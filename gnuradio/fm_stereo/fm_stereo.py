...
class fm_stereo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vco_f_0 = blocks.vco_f((audio_samp_rate*16), (19000*3.141592*2), 1.0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0, 0), (self.blocks_vco_f_0, 0))
        self.connect((self.analog_fm_deemph_0, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.analog_fm_deemph_0, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.analog_fm_deemph_0_0, 0), (self.blocks_float_to_complex_0, 1))
        self.connect((self.analog_fm_deemph_0_0, 0), (self.low_pass_filter_0_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.band_pass_filter_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.blocks_multiply_const_vxx_2, 0))
        ...
        self.connect((self.blocks_vco_f_0, 0), (self.blocks_null_sink_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_sub_xx_1_0, 0))
        self.connect((self.low_pass_filter_0_0_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.low_pass_filter_0_0_0, 0), (self.blocks_sub_xx_1, 0))
    ...
    def set_audio_samp_rate(self, audio_samp_rate):
        ...
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(100, (self.audio_samp_rate*16), 36000, 40000, 5000, window.WIN_RECTANGULAR, 6.76))
        self.band_pass_filter_0_1.set_taps(firdes.band_pass(2, (self.audio_samp_rate*16), 18000, 20000, 2000, window.WIN_RECTANGULAR, 6.76))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, (self.audio_samp_rate*32), 100000, 300000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, (self.audio_samp_rate*16), 15000, 1000, window.WIN_HAMMING, 6.76))
        ...
        self.low_pass_filter_0_0_0.set_taps(firdes.low_pass(1, (self.audio_samp_rate*16), 15000, 1000, window.WIN_HAMMING, 6.76))
