...
The main purpose of this amplifier is raise the signal level immediately after the antenna, to compensate for the loss of a long cable between the antenna and the receiver and therefore to ensure a low overall noise figure. DC power is supplied through the coax cable. The amplifying device is a Motorola MRF966 dual-gate MES-FET, capable of NF=0.6 dB at 450 MHz.
...
The output is implemented with a hand-wound broadband transmission line RF transformer, creating a 200Ω -> 50Ω transition. A 680Ω resistor (R4) degenerates any resonance peaks at the output, ensuring unconditional stability. 
