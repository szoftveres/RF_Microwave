...
% Kicad footprint "Capacitor_SMD:C_0402_1005Metric"
%  * X = 0.62 mm
%  * Y = 0.56 mm
% OSHPark 4-layer 
%  * h = 0.2 mm
...
feedline_end = smdpad_y + (inductor_y / 2);


% ============== Pads ======================

start = [-smdpad_x/2 -inductor_y/2 0];
...
start = [-inductor_x/2 -inductor_y/2 0];
stop = start + [inductor_x inductor_y copper_thickness];
CSX = AddBox( CSX, 'copper', 20,  start, stop);
...
Sim_Path = 'tmp_MICROSTRIP_0402PAD_COMP';
Sim_CSX = 'MICROSTRIP_0402PAD_COMP.xml';
